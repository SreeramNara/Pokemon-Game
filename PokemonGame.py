...
def rearranging():
	...
	mymainpokemon1 = {}
	print("\nYou will get an input and you have to type in the pokemon that you want to be in that place!\n")
	while len(mymainpokemon1.keys()) != len(mymainpokemon.keys()):
		pri = input("Please type in the name of the pokemon you have selected:")
		c = pri.split(" ")
		for i in c:
			c[c.index(i)] = i[0].upper()+i[1:len(i)]
		c = " ".join(c).strip()
		if c in mymainpokemon.keys():
			mymainpokemon1[c] = [pokemonhp[c], mymainpokemon[c][1]]
		print("\n\n")
	mymainpokemon = mymainpokemon1
		...
		if i in evolution1.keys():
			if xp >= 100:
				...
				if p == "y":
					...
					print("Wait, "+i+" is trying to evolve!")
					print(".")
					time.sleep(1)
					print("..")
					time.sleep(1)
...
print("Professor Oak: That was a good choice, now continue your journey!\n")
time.sleep(1)
